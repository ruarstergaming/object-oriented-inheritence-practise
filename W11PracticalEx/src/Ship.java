...
public class Ship { 
    ...
    private ArrayList<StandardCabin> cabins = new ArrayList<>();


    //Constructor that intitalises everything
    Ship(String shipName, int totalCapacity, int capacity, ArrayList<Destination> itinerary, ArrayList<Passenger> passengers, ArrayList<StandardCabin> cabins){
    ...
    public void printCabins(){
        ...
        // For loop to print every cabin's details 
        for(int i = 0; i < this.cabins.size(); i++){
    
            this.cabins.get(i).printDetails();
    ...
    public ArrayList<StandardCabin> getCabins() {
        return cabins;
    }

    public void setCabins(ArrayList<StandardCabin> cabins) {
        this.cabins = cabins;
    }
}
